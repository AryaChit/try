...
<form method="POST" action="" name="addbook" enctype="multipart/form-data" onsubmit="return validate()">
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="formFilePdf" class="form-label">Pdf File</label>
    <input class="form-control" type="file" id="formFilePdf" name="thumb">
